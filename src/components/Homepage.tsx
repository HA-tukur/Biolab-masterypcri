...
function HeroSection({ onStartFree }: { onStartFree: () => void }) {
  return (
    <section className="max-w-6xl mx-auto px-4 md:px-6 pt-12 md:pt-16 pb-16 md:pb-24">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center mb-6">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <Link
              to="/login"
              className="px-8 py-3 border border-gray-300 hover:border-gray-400 text-gray-700 text-base font-medium rounded-md transition-colors inline-flex items-center justify-center"
            >
              Instructor Portal
            </Link>
            <a
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 items-start justify-center text-base md:text-sm text-gray-600 mb-2">
        ...
        <div className="flex items-center justify-center gap-2 text-base md:text-sm text-gray-600">
